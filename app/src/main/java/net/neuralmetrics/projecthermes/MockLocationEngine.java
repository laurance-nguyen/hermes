...
public class MockLocationEngine extends LocationEngine {
  ...
  private static final int DEFAULT_SPEED = 60; // Miles per hour
  ...
  /**
   * Create a {@code net.neuralmetrics.projecthermes.MockLocationEngine} instance using the default parameters.
   *
   * @since 2.0.0
   */
  ...
  /**
   * Create a {@code net.neuralmetrics.projecthermes.MockLocationEngine} instance with custom parameters.
   *
  ...
  /**
   * While the {@code net.neuralmetrics.projecthermes.MockLocationEngine} is in use, you are always connected to it.
   *
   * @return true.
   */
  @Override
  ...
  public Location getLastLocation() {
    if (lastLocation.getLongitude() != 0 && lastLocation.getLatitude() != 0) {
      ...
      lastLocation.setLatitude(10.772799);
      lastLocation.setLongitude(106.657435);
      return lastLocation;
    }
  }
